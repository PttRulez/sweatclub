...
export type PrismaGameSession = Prisma.GameSessionGetPayload<typeof prismaGameSession>;

const gameSessionWithRelations = Prisma.validator<Prisma.GameSessionDefaultArgs>()({
